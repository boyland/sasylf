...
public enum Errors {
	...
	RULE_CONTEXT_INCONSISTENT ("contexts used in application of rule/theorem cannot be harmonized"),
	...
	CASE_STRICT_NEED_DEPEND ("case is overly strict; perhaps replace the following with something that could depend on the variable(s) in the context: "),
