...
public enum Errors {
	...
	IMPORTS_IN_MODULE ("'imports' legal only for explicit modules"),
	...
	IMPORT_IN_REQUIRES ("module import (using '= QualName') should be in an 'imports' section, not 'requires'"),
	...
	MOD_ARG_THEOREM_WRONG_NUM_FORALLS("Module theorem argument has the wrong number of foralls. "),
